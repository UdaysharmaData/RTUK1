...
class ExternalEnquiryListingQueryParamsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'status' => ['sometimes', 'nullable', new Enum(ExternalEnquiryStatusEnum::class)],
            'partner' => ['sometimes', 'nullable', 'exists:partners,ref'],
            'channel' => ['sometimes', 'nullable', 'exists:partner_channels,ref'],
            ...
            'order_by.*' => ['string', $this->isValidOrderByParameter(ListTypeEnum::ExternalEnquiries)],
