...
{
    use Response, HelperTrait, UploadTrait, UploadModelTrait, ImageValidator, GalleryValidator, HelperTrait;
    ...
    */
    ...
    public function _index(Request $request): JsonResponse
    {
        ...
        $categories = CharityCategory::with(['uploads', 'meta'])
            ->withCount('charities');
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        try {
            ...
            if ($request->filled('gallery')) { // Save the gallery
    ...
    public function edit(int $id): JsonResponse
    {
        ...
        return $this->success('Edit the charity category', 200, [
            'category' => new CharityCategoryResource($category),
            'robots' => MetaRobotsEnum::_options()
        ]);
    }
