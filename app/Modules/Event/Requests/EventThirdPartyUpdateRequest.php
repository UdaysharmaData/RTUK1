...
class EventThirdPartyUpdateRequest extends FormRequest
{
    ...
    {
        return [
            'external_id' => ['sometimes', 'required', 'alpha_num'],
            ...
            'partner_channel' => ['bail', 'sometimes', 'required', 'string', Rule::exists('partner_channels', 'ref')->where(function ($query) { // The partner channel must exists and belong to the site making the request
