...
class TwoFactorAuthenticationMethodDisabled extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable): MailMessage
    {
        ...
        $mailMessage = (new MailMessage)
            ...
            ->subject('Two Factor Authentication: Method Disabled')
            ->greeting('Hello ' . $notifiable->salutation_name . ', ')
            ->line("<div>You have just disabled two-factor authentication through <strong>$this->method</strong>.</div>")
            ->salutation('Thanks!');
