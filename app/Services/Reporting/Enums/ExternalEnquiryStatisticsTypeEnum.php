...
enum ExternalEnquiryStatisticsTypeEnum: string implements OrganisationExcludes
{
    ...
    {
        return [
            OrganisationCodeEnum::GWActive->value => [ExternalEnquiryStatisticsTypeEnum::Charities]
        ];
    }
}