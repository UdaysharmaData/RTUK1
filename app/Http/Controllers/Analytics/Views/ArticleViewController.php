...
class ArticleViewController extends AnalyticsController
{
    use Response;
    ...
    {
        AnalyticsViewEvent::dispatch($article);

        return $this->success('Article view registered.', 200, [
