...
return [
    ...
    |
    */
    'path' => env('RUNFORCHARITY_SITEMAP_PATH'), // Absolute path to the file eg /Users/mesmer/Desktop/Sitemap

    'frontend_path' => env('RUNFORCHARITY_SITEMAP_FRONTEND_PATH'), // The path where the file is to be saved on the server. This was added due to the way sitemap is setup on our aws hosting. eg /Users/mesmer/Desktop/Sitemap
    ...
    */
    ...
    |
    */
    'update_frequency' => env('RUNFORCHARITY_SITEMAP_UPDATE_FREQUENCY', 'daily'),

    'regenerate_frequency' => env('RUNFORCHARITY_SITEMAP_REGENERATE_FREQUENCY', 'monthly'),
