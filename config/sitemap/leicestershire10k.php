...
return [
    ...
    |
    */
    'path' => env('LEICESTERSHIRE10K_SITEMAP_PATH'), // Absolute path to the file eg /Users/mesmer/Desktop/Sitemap

    'frontend_path' => env('LEICESTERSHIRE10K_SITEMAP_FRONTEND_PATH'), // The path where the file is to be saved on the server. This was added due to the way sitemap is setup on our aws hosting. eg /Users/mesmer/Desktop/Sitemap
    ...
    */
    ...
    |
    */
    'update_frequency' => env('LEICESTERSHIRE10K_SITEMAP_UPDATE_FREQUENCY', 'daily'),

    'regenerate_frequency' => env('LEICESTERSHIRE10K_SITEMAP_REGENERATE_FREQUENCY', 'monthly'),
