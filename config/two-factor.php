...
return [
    ...
    */
    ...
    'safe_devices' => [
        ...
        'max_devices'     => env('MAX_SAFE_DEVICES', 5),
        'expiration_days' => env('SAFE_DEVICES_EXPIRATION_DAYS', 14),
    ],
    ...
    */
    ...
    'issuer' => env('APP_NAME', 'SportsMediaAgency'),
    ...
    */
    ...
    'token_expiration_time' => env('TWO_FACTOR_TOKEN_EXPIRATION_TIME', 1)
];
