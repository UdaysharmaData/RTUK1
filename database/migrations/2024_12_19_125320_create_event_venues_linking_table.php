...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('event_venues_linking', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('venue_id'); // Foreign key for regions
    ...
    {
        Schema::dropIfExists('event_venues_linking');
    }
};
