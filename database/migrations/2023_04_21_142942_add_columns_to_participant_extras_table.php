...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('participant_extras', function (Blueprint $table) {
            if (! Schema::hasColumn('participant_extras', 'ethnicity')) {
                $table->string('ethnicity')->after('gender')->nullable();
            }

            if (! Schema::hasColumn('participant_extras', 'club')) {
                $table->string('club')->after('ethnicity')->nullable();
            }

            if (! Schema::hasColumn('participant_extras', 'weekly_physical_activity')) {
                $table->string('weekly_physical_activity')->after('ethnicity')->nullable();
            }
